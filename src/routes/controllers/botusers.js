...
router.post("/", async (req, res) => {
  try {
    ...
    const { name, phone, email, createUser, canSOS, adminPdf, manager, area, clientId, createdBy } =
      req.body;
    ...
    console.error(error); // Imprimir el error completo en la consola para más detalles
